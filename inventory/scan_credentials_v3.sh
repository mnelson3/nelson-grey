#!/usr/bin/env bash
# Scan script using find with -print0 for robust filenames
...
find "$ROOT_DIR" -type f \( -iname "*.p12" -o -iname "*.pfx" -o -iname "*.pem" -o -iname "*.cer" -o -iname "*.crt" -o -iname "*.p8" -o -iname "*.mobileprovision" -o -iname "firebase-service-account-*.json" -o -iname "*.plist" -o -iname ".github-app-private-key.pem" \) -print0 |
